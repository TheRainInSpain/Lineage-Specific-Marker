...
do
    fn=${fasta%.fasta}
    echo "clustering $fasta..."
    vsearch --cluster_size $fasta --id 0.85 --iddef 4 --centroids $vsearch_output_folder/centroids_fasta/$fn.fasta --uc $vsearch_output_folder/uc_files/$fn.uc --consout $vsearch_output_folder/consensus_fasta/$fn.fasta
